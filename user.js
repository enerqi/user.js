...
user_pref("mouselessbrowsing.keys.openInNewTabPostfixKey", "0");
user_pref("mouselessbrowsing.keys.openInNewWindowPostfixKey", "0");
user_pref("mouselessbrowsing.keys.toggleMLB", "514");
